...
$query = "SELECT title, description, date, start_time, end_time, location FROM events JOIN registration ON EID=event_id WHERE user_id='$UID' AND registration.status='Registered' ORDER BY date;";
