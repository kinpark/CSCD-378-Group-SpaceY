...
<body>
    <div id="container">
        <div id="info">
            ...
            <h2>At this site you can find, create, and register for events all in one place.</h2>
        ...
        <div class="wrapper">
            ...
            <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                ...
                <p>Forgot your password? <a href="Forgetpass.php">Fix it here</a>.</p>
            </form>
        </div>
    </div>    
</body>
